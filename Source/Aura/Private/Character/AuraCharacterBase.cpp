...
AAuraCharacterBase::AAuraCharacterBase()
{
	...
	// Set up weapon and weapon socket
	Weapon = CreateDefaultSubobject<USkeletalMeshComponent>("Weapon");
	Weapon->SetupAttachment(GetMesh(), FName("WeaponHandSocket"));
	Weapon->SetCollisionEnabled(ECollisionEnabled::NoCollision);

	EffectAttachComponent = CreateDefaultSubobject<USceneComponent>("PassiveNiagaraEffects");
...
void AAuraCharacterBase::SetIsBeingShocked_Implementation(bool bValue)
{
	bIsBeingShocked = bValue;
}
